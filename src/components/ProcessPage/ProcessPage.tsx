        ...
        <div className={styles.content}>
          ...
          <Section title="Подготовка ассетов" className={styles.assetsSection}>
            <div className={styles.narrowProse}>
              ...
              <p>Часть объектов я правил самостоятельно, часть повторно отдавал на генерацию. Однако!!
              ассеты все равно не доведены до идеала и видны артефакты, понятное дело в прод такое качество
              не пойдет и точно бы все было доработано!</p>
              <p>
