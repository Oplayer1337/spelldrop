...
const fixes = [
  {
    title: 'Ассеты',
    text: 'Codex не сразу сопоставил реальные имена файлов с вариантами конфигуратора, поэтому внутри появился placeholder. Я попросил его сначала просканировать директории и создать единый asset manifest.',
  },
  {
    title: 'Анимация',
    text: 'При выборе элементов экран дёргался вверх. После отдельной проверки переходы были заменены на короткий fade без изменения scroll-позиции.',
  },
  {
    title: 'Высота',
        ...
        <div className={styles.content}>
          <Section title="От заклинаний к зельям" className={styles.ideaSection}>
            <div className={styles.proseWithAssets}>
              <div>
                <p>
                  Я начал с разбора задания и сбора референсов. За основу визуального направления взял
                  образ девушки с фиолетовыми волосами из материалов Duolingo — мне понравились простые
                  формы, яркий персонаж и дружелюбная product-style подача.
                </p>
                <p>
                  Само заклинание я решил представить в виде зелья. Заклинание — довольно абстрактная
                  вещь, а зелье воспринимается как понятный физический продукт: его можно выбрать,
                  настроить, упаковать и доставить.
                </p>
                <p>
                  Так появилась основная идея SPELLDROP — пользователь собирает подходящее зелье, а
          ...
          <Section title="Сначала механика, потом экран">
            <div className={styles.narrowProse}>
              ...
              <p>
                Главным интерактивным элементом стал конфигуратор: пользователь выбирает ситуацию,
                добавляет эффекты, подбирает размер флакона и способ доставки.
              </p>
              <p>
                Мне не хотелось делать обычный каталог зелий. Интереснее было создать ощущение, что
                продукт собирается специально под конкретную ситуацию пользователя.
              </p>
            </div>
          ...
          <Section title="Почему оплата — кармой" className={styles.karmaSection}>
            <div className={styles.karmaLayout}>
              <div className={styles.narrowProse}>
                ...
                <blockquote>Материалы — за золотые, магия — за хорошую карму.</blockquote>
              </div>
          ...
          <Section title="Поиск визуального направления">
            <div className={styles.narrowProse}>
          ...
          <Section title="Как я передавал дизайн в разработку" className={styles.codexSection}>
            ...
            <p className={styles.callout}>
              Я быстро понял, что запроса “собери сайт по картинке” недостаточно. Codex лучше работал,
              когда получал ограниченную задачу, конкретный референс и список того, что нельзя менять.
            </p>
          </Section>
          ...
          <Section title="Что пришлось исправлять" className={styles.fixesSection}>
            ...
            <blockquote className={styles.teleportQuote}>
              Обернитесь — зелье уже за вашей спиной. Если там нашлось достаточно места.
            </blockquote>
          </Section>
          ...
          <Section title="Результат" className={styles.resultSection}>
            <div className={styles.narrowProse}>
              <p>
                ...
                логику, визуальный дизайн, генеративную графику и frontend-разработку.
              </p>
              ...
              <p>
                При этом часть ассетов всё ещё находится на уровне прототипа. Их можно дополнительно
              ...
              <p className={styles.finalStatement}>
                Для меня ценность проекта не только в финальном лендинге, но и в выстроенном процессе — от
                идеи до управляемой работы с AI и работающего интерфейса.
              </p>
            </div>
          </Section>
        </div>
